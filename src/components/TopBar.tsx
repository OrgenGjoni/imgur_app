...
const TopBar = ()=>{
  ...
  const handleSwitch = (e : React.ChangeEvent<HTMLInputElement>)=>{
    dispatch(setViral(e.target.checked));
  }

  const changeSection = (sect : string) : void =>{
  ...
  const changeWindow = (wind : string) : void =>{
